...
import { RouteVehicleColorSection, RouteVehicleMouseToolOptions } from "mods/route-vehicle-tool-section";
...
const register: ModRegistrar = (moduleRegistry) => {
    ...
    moduleRegistry.extend(MOUSE_TOOL_OPTIONS_MODULE, "Section", RouteVehicleColorSection);
